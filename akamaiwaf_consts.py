...
AKAMAI_CLIENT_LIST_API_PATH = "/client-list/v1/lists"
AKAMAI_CLIENT_LIST_ENDPOINT = AKAMAI_CLIENT_LIST_API_PATH + "/{}"
AKAMAI_CLIENT_LIST_ENTRIES_ENDPOINT = AKAMAI_CLIENT_LIST_ENDPOINT + "/items"
AKAMAI_CLIENT_LIST_ACTIVATION_ENDPOINT = AKAMAI_CLIENT_LIST_ENDPOINT + "/activations"
